...
Przy mieszaniu perfum używam małych 0,2 ml jednorazowych pipet - osobną pipetę do każdej substancji. Możesz też używać szklanych pipet, ale musisz później pamiętać, żeby dobrze je umyć - pewnie trzeba by je wymoczyć w alkoholu przez kilka godzin po każdym użyciu. Chodzi o to, żeby nie nastąpiła kontaminacja między różnymi substancjami zapachowymi. Większe pipety stosuję do frakcjonowanego oleju kokosowego i oleju jojoba, bo tych dodaje się po prostu więcej.
...
Do perfum dodaję również witaminę E, żeby wydłużyć ich trwałość i chronić przed utlenianiem. Niedużo - około 0,5%.

### Ochrona przed światłem

Żeby chronić gotowe perfumy przed światłem, używam brązowych buteleczek. Gdybym używał przezroczystych buteleczek, musiałbym stosować filtry UV chroniące składniki perfum przed słońcem.
